...
//   mapping(uint256 => RequestDetail) private $details;
...
//   {
//     RequestDetail memory req = $details[requestId_];
...
//     $details[requestId_].randomWords = randomWords_;
...
//     $details[requestId] = RequestDetail({requested: true, fulfilled: false, randomWords: new uint256[](0)});
